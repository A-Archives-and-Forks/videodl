...
class VideoClientBuilder(BaseModuleBuilder):
    REGISTERED_MODULES = {
        ...
        'SixRoomVideoClient': SixRoomVideoClient, 'DuxiaoshiVideoClient': DuxiaoshiVideoClient, 'ZuiyouVideoClient': ZuiyouVideoClient, 'ZhihuVideoClient': ZhihuVideoClient, 
        ...
        'CCTVVideoClient': CCTVVideoClient, 'SohuVideoClient': SohuVideoClient, 'YouTubeVideoClient': YouTubeVideoClient, 'XinpianchangVideoClient': XinpianchangVideoClient, 
